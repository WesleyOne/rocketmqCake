...
![]({{ site.baseurl }}/image/rocketmq_design_1.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_2.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_3.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_4.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_5.png)

#### 2.4 Reactor多线程设计
RocketMQ的RPC通信采用Netty组件作为底层通信库，同样也遵循了Reactor多线程模型，同时又在这之上做了一些扩展和优化。

![]({{ site.baseurl }}/image/rocketmq_design_6.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_7.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_10.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_11.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_12.png)
...
![]({{ site.baseurl }}/image/rocketmq_design_13.png)
